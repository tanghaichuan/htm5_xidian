...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<ul class="breadcrumb">
				...
				<li>
					<a href="#">美食鉴赏</a> <span class="divider">/</span>
				</li>
				<li>
					<a href="French.html">法式美食</a> <span class="divider">/</span>
				</li>
				<li class="active">
					当前
				</li>
	...
	<br/><br/>	<br/>
		...
		<div class="col-md-4">
			<img alt="Bootstrap Image Preview" src="/html5-xidian/Public/home/images/food-content-0.png" />
		</div>
		<!-- 制作步骤 -->
		<div class="col-md-7">
			
				<font face="仿宋" size="12px">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;草莓慕斯
				</font>
			...
			<div>
				<div class="col-md-11">
					<font face="仿宋" size="6px">
					  菜品食材：
				   </font>
			    <font face="仿宋" size="5px">
			...
			<div>
			    ...
			    <font face="仿宋" size="5px">
					  1、将糖和草莓混合留用；<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2、开水把果冻粉调融，把果冻，炼奶，奶油倒进搅拌器。打成浆；<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3、在一容器中放入草莓丁，然后倒进奶浆；<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4、放进冰箱冷冻3个小时以上即成 
				   </font>
				</div>
				  <div class="col-md-1"></div>
			    <br /> <br />
			...
			<br/><br/><br/><br/><br/><br/><br/><br/>
				...
				<div class="col-md-10">
					<div class="title-a">
				  <font face="仿宋" size="5px">收藏   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;评论</font></div>
