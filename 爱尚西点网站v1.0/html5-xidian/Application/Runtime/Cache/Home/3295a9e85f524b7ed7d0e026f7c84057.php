...
<body>
    ...
    <div class="row clearfix">
      <div class="col-md-12 column">
        <div class="row">
          <div class="col-md-3">
            <div class="thumbnail">
              <img class="shopping_pic" src="/html5-xidian/Public/home/images/avater.jpeg" />
              <div class="caption">
                <p style="padding: 0px 8px"><a href="#">菲力牛排套装8份装</a></p>
                <div><b class="price">￥10</b></div><a class="btn" href="#" style="color: #fff">加入购物车</a>
                <div class="count">
  ...
  <div class="one clearfix">
    <div class="two clearfix">
        ...
        <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><div class="three">
                <div class="four">
                    <a href="/html5-xidian/home.php/Home/shop/content.html" target="_blank">
                        <img alt="<?php echo ($n["name"]); ?>" src="/html5-xidian/Public/<?php echo ($n["img"]); ?>">
                    </a>       
                </div>
                <div class="five">
                    <a href="/html5-xidian/home.php/Home/shop/content.html" target="_blank" title="<?php echo ($n["name"]); ?>">
