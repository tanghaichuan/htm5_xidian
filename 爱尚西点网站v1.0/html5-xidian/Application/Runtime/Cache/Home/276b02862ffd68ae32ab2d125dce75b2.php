...
<!--页头-->
  ...
  <div class="container-fluid">
  	<div class="row">
  		<div class="col-md-12">
  			<img alt="美式餐点" src="/html5-xidian/Public/home/images/food-US-0.png" class=""/>
  		</div>
  	</div>
  	<br / >
  	<div class="row">
	...
	<div class="row">
		<div class="col-md-1 col-sm-1 col-xs-1">
			<!-- 文字实现竖排 -->
			<div class="font-a">美式餐点</div>
		</div>
		<div class="col-md-11 col-sm-11 col-xs-11">
			<div class="row">
				
					<p>
						<div class="font-b">美国式饮食不讲究精细，追求快捷方便，比较大众化。一日三餐都比较随便。它的特色是粗狂实在，使用新鲜的原材料，不靠添加剂，调味剂，食物保持原汁原味，烹饪的过程不拖泥带水。</div>
					</p>
				<br /><br />
			  </div><!-- 下方为图片列表内容   -->
				
         <div class="row">
              <?php if(is_array($food)): $i = 0; $__LIST__ = $food;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$n): $mod = ($i % 2 );++$i;?><div class="col-md-3 col-sm-4 col-xs-5">
                      <div class="thumbnail" id="thumbnail">

                            <figure class="templet ">
                                <img alt="意式餐点" src="/html5-xidian/Public/<?php echo ($n["img"]); ?>" id="food-thumb"  />
                                <figcaption>
                                    <h3><?php echo ($n["name"]); ?></h3>
                                    <p>by&nbsp;&nbsp;zhangsan</p>
                                    <p>发布于&nbsp;&nbsp;<?php echo ($n["food_public_time"]); ?></p>
                                </figcaption>
