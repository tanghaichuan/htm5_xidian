      ...
      <div class="row clearfix" style="padding: 40px 0px;">
        ...
        <div class="col-md-9 column">
          <div style="background-color: white;border-radius: 1px;margin: 0px 45px 0px 20px;">
            ...
            <form action="<?php echo U('Home/users/reset_information');?>" method="post" class="form-horizontal" role="form" enctype="multipart/form-data" style="padding: 0px 50px 0px 20px;" >
            <div class="form-group">
               <label class="col-sm-2 control-label">用户名:</label>
              <div class="col-sm-3">
                <p style="padding: 5px 0px 0px 0px;"><?php echo ($data["username"]); ?></p>
              </div>
            </div>
            <div class="form-group">
               <label class="col-sm-2 control-label">昵称:</label>
              <div class="col-sm-3">
                <input type="text" class="form-control" placeholder="请输入昵称" name="realname" value="<?php echo ($data["realname"]); ?>"/>
              </div>
            </div>
            <div class="form-group">
               <label class="col-sm-2 control-label">电话:</label>
              <div class="col-sm-3">
                <input type="text" class="form-control" placeholder="请输入电话" name="telphone" value="<?php echo ($data["telphone"]); ?>"/>
              </div>
            </div>
            </br>
            <div class="form-group">
