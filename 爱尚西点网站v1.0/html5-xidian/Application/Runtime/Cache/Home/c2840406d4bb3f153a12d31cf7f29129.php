          ...
          <ul class="nav navbar-nav navbar-right" style="font-weight: bold;color: black;">
           ...
           <li class="dropdown">
             ...
             <ul class="dropdown-menu" style="text-align: right;min-width: 100px;">
                <li>
                   <a href="French.html">法式菜肴</a>
                </li>
                <li>
                   <a href="UK.html">英式菜肴</a>
                </li>
                <li>
                   <a href="US.html">美式菜肴</a>
                </li>
               
                <li>
                   <a href="Italy.html">意式菜肴</a>
                </li>
                 <li>
                   <a href="Russian.html">俄式菜肴</a>
                </li>
              </ul>
            </li>
            <li class="dropdown">
...
<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12">
			<img alt="意式餐点" src="/html5-xidian/Public/home/images/food-I-0.png" class=""/>
		</div>
	</div>
	<br / >
	<div class="row">
		<div class="col-md-12">
			<div class="row">
				<div class="col-md-12">
					<ul class="breadcrumb">
						<li>
							<a href="#"><font face="微软雅黑" size="5px">首页</font></a> <span class="divider">/</span>
						</li>
						<li>
							<a href="#"><font face="微软雅黑" size="5px">美食鉴赏</font></a> <span class="divider">/</span>
						</li>
						<li class="active"><font face="微软雅黑" size="5px">
							意式餐点</font>
						</li>
					</ul>
				</div>
	...
	<div class="row">
		<div class="col-md-1">
			<!-- 文字实现竖排 -->
			<div class="font"><font face="仿宋" size="12px">意式餐点</font></div>
		</div>
		<div class="col-md-11">
			<div class="row">
				<div class="col-md-1">
				...
				<div class="col-md-11">
					<p>
						<font face="仿宋" size="5px">意大利民族是一个美食家的民族，他们在饮食方面有着悠久的历史，他们总是喜欢精心制作。意大利美食典雅高贵，且浓重朴实，讲究原汁原味。</font>
					</p>
				</div>
				<br /><br /><br /><br />
			</div><!-- 下方为图片列表内容   -->
				<!-- 第一行图片 -->
					<div class="row">
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-8">
									<a href="content.html"><img alt="意式餐点" src="/html5-xidian/Public/home/images/food-I-1.png" /></a>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
									<div class="font"><font face="仿宋" size="6px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;迷迭香羊腿</font></div>
								</div>
						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-8">
									<a href="content.html"><img alt="意式餐点" src="/html5-xidian/Public/home/images/food-I-2.png" /></a>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
									<div class="font"><font face="仿宋" size="6px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;香煎三文鱼</font></div>
								</div>
						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-8">
									<a href="content.html"><img alt="意式餐点" src="/html5-xidian/Public/home/images/food-I-3.png" /></a>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
									<div class="font"><font face="仿宋" size="6px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;盐焗海鲈</font></div>
								</div>
					...
					<!-- 第二行图片 -->
						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-8">
									<a href="content.html"><img alt="意式餐点" src="/html5-xidian/Public/home/images/food-I-4.png" /></a>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
									<div class="font"><font face="仿宋" size="6px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;披萨</font></div>
								</div>
						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-8">
									<a href="content.html"><img alt="意式餐点" src="/html5-xidian/Public/home/images/food-I-5.png" /></a>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
									<div class="font"><font face="仿宋" size="6px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意式烩饭</font></div>
								</div>
						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-8">
									<a href="content.html"><img alt="意式餐点" src="/html5-xidian/Public/home/images/food-I-6.png" /></a>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
									<div class="font"><font face="仿宋" size="6px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意式浓汤</font></div>
								</div>
					...
					<!-- 第三行图片 -->
						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-8">
									<a href="content.html"><img alt="意式餐点" src="/html5-xidian/Public/home/images/food-I-7.png" /></a>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
									<div class="font"><font face="仿宋" size="6px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;意式三明治</font></div>
								</div>
						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-8">
									<a href="content.html"><img alt="意式餐点" src="/html5-xidian/Public/home/images/food-I-8.png" /></a>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
									<div class="font"><font face="仿宋" size="6px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;墨鱼汁意面</font></div>
								</div>
						...
						<div class="col-md-4">
							<div class="row">
								<div class="col-md-8">
									<a href="content.html"><img alt="意式餐点" src="/html5-xidian/Public/home/images/food-I-9.png" /></a>
								</div>
								<div class="col-md-1">
								</div>
								<div class="col-md-3">
									<div class="font"><font face="仿宋" size="6px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;海鲜沙拉</font></div>
								</div>
...
<script src="js/jquery.js"></script>
  <script src="js/bootstrap.min.js"></script>
      <script src="js/homeEdit.js"></script>
       <script src="js/homeEdit.js"></script>
</body>
</html>